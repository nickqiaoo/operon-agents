import { globMatch, pathGlobMatch, type PermissionPathMatchOptions } from "./path-glob-match.ts";
...
export function matchesPathRuleSubject(
  ...
  return matchRuleSubjects(ruleArgs, [subject], (pattern, value) => pathGlobMatch(value, pattern, options));
}
