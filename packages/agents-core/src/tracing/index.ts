...
export type { SpanData, SpanType, SpanError, SpanEvent, SpanRecord, TraceRecord, GenerationUsage, GenerationInputMode, GenerationOutputPart } from "./spans.ts";
export {
...
export type { TracingProcessor, TracingExporter, TracingContentMode, BatchTracingProcessorOptions, TraceOrSpan } from "./processor.ts";
